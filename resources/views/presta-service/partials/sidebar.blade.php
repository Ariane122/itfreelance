 ...
 <div class="col-sm-3 col-xs-6 sidebar pl-0">
     <div class="inner-sidebar mr-3">
         ...
         <div class="avatar text-center">
             <img src="{{ asset('presta-service/assets/img/profile.jpg') }}" alt="" class="rounded-circle" />
             <p>
                 <strong>
             ...
             <ul class="sidebar-menu mt-4 mb-4">
                 <li class="parent">
                     <a href="#" class=""><i class="fa fa-dashboard mr-3"> </i>
                         <span class="none">Tableau de board </span>
                     </a>
                     {{-- <ul class="children" id="dashboard">
                         <li class="child"><a href="index.html" class="ml-4"><i class="fa fa-angle-right mr-2"></i>
                                 Default</a></li>
                         <li class="child"><a href="index2.html" class="ml-4"><i class="fa fa-angle-right mr-2"></i>
                                 Analytics</a></li>
                         <li class="child"><a href="index3.html" class="ml-4"><i class="fa fa-angle-right mr-2"></i>
                                 Ecommerce</a></li>
                         <li class="child"><a href="index4.html" class="ml-4"><i class="fa fa-angle-right mr-2"></i>
                                 Cryptocurrency</a></li>
                     </ul> --}}
                 </li>
                 </li>
                 ...
                 @if (Auth::user()->role == 2)
                     <li class="parent">
                         <a href="#" onclick="toggle_menu('maps'); return false" class=""><i
                             ...
                             <span class="none">Mes contrats <i
                                     class="fa fa-angle-down pull-right align-bottom"></i></span>
                         </a>
                         <ul class="children" id="maps">
                             {{-- <li class="child">
                                <a href="jvector-maps.html" class="ml-4">
                                <i class="fa fa-angle-right mr-2"></i>
                                    Encours
                                </a>
                            </li>
                             <li class="child"><a href="jvector-maps.html" class="ml-4"><i
                                            class="fa fa-angle-right mr-2"></i>Terminé</a>
                             </li> --}}
                             <li class="child">
                                <a href="{{ url('contrats') }}" class="ml-4">
                                    <i class="fa fa-angle-right mr-2"></i>
                                    Calendrier
                                </a>
                            </li>
                 ...
                 @else
                     <li class="parent">
                         <a href="#" onclick="toggle_menu('maps'); return false" class=""><i
                                 class="fa fa-map mr-3"></i>
                             <span class="none">Nos Projets <i
                                     class="fa fa-angle-down pull-right align-bottom"></i></span>
                         </a>
                         <ul class="children" id="maps">
                             <li class="child"><a href="jvector-maps.html" class="ml-4"><i
                                         class="fa fa-angle-right mr-2"></i> Encours</a></li>
                             <li class="child"><a href="google-maps.html" class="ml-4"><i
                                         class="fa fa-angle-right mr-2"></i> Terminé</a></li>
                         </ul>
                     </li>
                 @endif
