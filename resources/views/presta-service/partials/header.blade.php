            ...
            <div class="col-sm-4 col-8 pl-0">
                ...
                <span class="menu-icon inbox">
                    ...
                    <div class="dropdown-menu dropdown-menu-left mt-10 animated zoomInDown" aria-labelledby="dropdownMenuLink3">
                        ...
                        <a href="#" class="dropdown-item">
                            <div class="media">
                                <img class="align-self-center mr-3 rounded-circle" src="{{ asset('presta-service/assets/img/profile.jpg') }}" width="50px" height="50px" alt="Generic placeholder image">
                                <div class="media-body">
            ...
            <div class="col-sm-8 col-4 text-right flex-header-menu justify-content-end">
                ...
                <div class="mr-4">
                    <a class="" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ asset('presta-service/assets/img/profile.jpg') }}" alt="Adam" class="rounded-circle" width="40px" height="40px">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right mt-13" aria-labelledby="dropdownMenuLink">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('logout') }}"><i class="fa fa-power-off pr-2"></i> Logout</a>
                    </div>
                </div>
            </div>
            <!--Search box and avatar-->
