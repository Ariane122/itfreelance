    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <h1
                                ...
                                YOUR PROFILE HAS BEEN SUCCESSFULLY SAVED</h1>
                        </td>
                    </tr>
                </table>
                <!--[if (gte mso 9)|(IE)]>
        ...
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            style="padding: 30px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Cheers,<br> it-freeelance</p>
                        </td>
                    </tr>
                    <!-- end copy -->
