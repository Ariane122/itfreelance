<div class="left-side-menu">
    ...
    <div class="h-100" data-simplebar>
        ...
        <div class="user-box text-center">
            <img src="{{ asset('back/assets/images/users/user-1.jpg') }}" alt="user-img" title="Mat Helme" class="rounded-circle avatar-md">
            <div class="dropdown">
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarDashboards">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a class="nav-link" href="{{ route('admin.projet') }}">Projets</a>
                            </li>
                            <li>
                                <a class="nav-link" href="{{ route('admin.entreprise.index') }}">Entreprises</a>
                            </li>

                            <li>
                                <a class="nav-link" href="{{ route('admin.prestataire.index') }}">Prestataires</a>
                            </li>

                            <li>
                                <a class="nav-link" href="{{ route('admin.contrat.index') }}">Contrats</a>
                            </li>
