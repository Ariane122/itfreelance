        ...
        <div class="widget-rounded-circle card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-end">
                            <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $prestataires_count }}</span></h3>
                            <p class="text-muted mb-1 text-truncate">Total Freelanceurs</p>
                        </div>
                    </div>
                </div> <!-- end row-->
            </div>
        ...
        <div class="widget-rounded-circle card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-end">
                            <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ $missions }}</span></h3>
                            <p class="text-muted mb-1 text-truncate">Total Projets</p>
                        </div>
                    </div>
                </div> <!-- end row-->
            </div>
        ...
        <div class="widget-rounded-circle card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-end">
                            <h3 class="text-dark mt-1"><span data-plugin="counterup">75</span>%</h3>
                            <p class="text-muted mb-1 text-truncate">Projets livré</p>
                        </div>
                    </div>
                </div> <!-- end row-->
            </div>
        ...
        <div class="widget-rounded-circle card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-end">
                            <h3 class="text-dark mt-1"><span data-plugin="counterup">25</span>%</h3>
                            <p class="text-muted mb-1 text-truncate">Projets en attente</p>
                        </div>
                    </div>
                </div> <!-- end row-->
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    <img src="{{ asset('back/assets/images/users/user-2.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                </td>

                                <td>
                                    <h5 class="m-0 fw-normal">{{ $prestataire->user->nom }} {{ $prestataire->user->prenom }}</h5>
